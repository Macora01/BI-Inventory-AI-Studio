...
const ReportsPage: React.FC = () => {
    const { movements, products, locations, stock: currentStock } = useInventory();
    ...
    /**
     * Genera un informe de existencias a una fecha determinada.
     */
    const handleGenerateInventoryReport = () => {
        ...
        // Calculamos el stock a esa fecha
        // Stock = Suma de movimientos hasta esa fecha
        ...
        movements.forEach(m => {
            ...
            // Si filtramos por ubicación, solo consideramos movimientos que afecten a esa ubicación
            ...
            // Lógica de suma/resta según el tipo de movimiento y la ubicación seleccionada
            if (selectedLocationId === 'all') {
                // Para "Todos", solo nos importan entradas/salidas externas al sistema global
                ...
                // Los traslados entre bodegas no cambian el stock total global
            } else {
            ...
            <Card>
                <div className="space-y-6">
                    ...
                    {reportType === 'sales' ? (
                        ...
                        <div className="space-y-6 animate-in fade-in duration-300">
                            {/* Filtros Existencias */}
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-accent bg-opacity-30 rounded-lg border border-accent">
                                <div className="space-y-1">
                            ...
                            <tbody className="divide-y divide-accent">
                                {reportType === 'sales' ? (
                                    ...
                                    inventoryReportData.length > 0 ? inventoryReportData.map(item => (
                                        <tr key={item.productId} className="bg-white hover:bg-accent hover:bg-opacity-10 transition-colors">
